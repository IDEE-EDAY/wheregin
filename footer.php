					...
					<div class="pull-right">
						<?php
							if( !empty( $footer_facebook ) ){
								?>
								<a href="<?php echo esc_url( $footer_facebook ) ?>" class="btn facebook"><i class="fa fa-facebook"></i></a>
								<?php
							}
							if( !empty( $footer_twitter ) ){
								?>
								<a href="<?php echo esc_url( $footer_twitter ) ?>" class="btn twitter"><i class="fa fa-twitter"></i></a>
								<?php
							}
							if( !empty( $footer_google ) ){
								?>
								<a href="<?php echo esc_url( $footer_google ) ?>" class="btn google"><i class="fa fa-google-plus"></i></a>
								<?php
							}						
						?>
					</div>
