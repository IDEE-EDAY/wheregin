...
<meta name="keywords" content="<?php echo esc_attr( couponxl_get_option( 'seo_keywords' ) ) ?>" />
<meta name="description" content="<?php echo esc_attr( couponxl_get_option( 'seo_description' ) ) ?>">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 collapse account-collapse">
                <div class="text-right">
                    ...
                    ?>
                        <a href="<?php echo esc_url( $top_bar_facebook_link ); ?>" class="btn facebook">
                    ...
                    ?>
                        <a href="<?php echo esc_url( $top_bar_twitter_link ); ?>" class="btn twitter">
                    ...
                    ?>
                        <a href="<?php echo esc_url( $top_bar_google_link ); ?>" class="btn google">
                ...
                <div class="col-md-3 col-xs-3">
                    <?php if( !empty( $site_logo['url'] ) ): ?>
                        <a href="<?php echo esc_url( home_url('/') ); ?>" class="site-logo">    
                            <img src="<?php echo esc_url( $site_logo['url'] ); ?>" title="" alt="">
                        </a>
                    <?php endif; ?>
                </div>
