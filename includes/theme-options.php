...
if (!class_exists('CouponXL_Options')) {
    ...
    class CouponXL_Options
    {
        ...
        public function setSections()
        {
            ...
            // SEO //
            $this->sections[] = array(
                'title' => __('SEO', 'couponxl'),
                'desc' => __('Seto search engine optiomization fields.', 'couponxl'),
                'icon' => '',
                'subsection' => true,
                'fields' => array(
                    ...
                    array(
                        'id' => 'seo_keywords',
                        'type' => 'text',
                        'title' => __('SEO Keywords', 'couponxl'),
                        'desc' => __('Input comma separated lsit of the site keywords.', 'couponxl'),
                    ),
                    array(
                        'id' => 'seo_description',
                        'type' => 'textarea',
                        'title' => __('SEO Description', 'couponxl'),
                        'desc' => __('Input site description.', 'couponxl'),
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'multi' => true,
                        'sortable' => true,
                        'options' => couponxl_get_custom_list('offer', array(
                            'meta_query' => array(
                                'relation' => 'AND',
                                array(
                                    'key' => 'offer_in_slider',
