...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name       = 'couponxl'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		...
		public function set_demo_menus(){
			...
			$top_menu    = get_term_by('name', 'Top Navigation', 'nav_menu');

			set_theme_mod( 'nav_menu_locations', array(
					'top-navigation' => $top_menu->term_id,
				)
			);
