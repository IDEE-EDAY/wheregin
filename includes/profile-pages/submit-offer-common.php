...
if( $is_paypal == 'yes' ){
	if( $subaction == 'paid_offer' ){
		...
		if( get_current_user_id() == $offer->post_author ){
			...
			$message = '<div class="alert alert-success">'.__( 'Coupon is deleted', 'couponxl' ).'</div>';
		}
	}
}
...
$offer_new_category = isset( $_POST['offer_title'] ) ? $_POST['offer_new_category'] : '';
