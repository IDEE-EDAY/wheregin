...
<div>
    ...
    <div class="input-group">
        ...
        <div class="alert alert-info shared_info">
            ...
            <p><?php _e( 'Sell discounted products and services trough website.', 'couponxl' ) ?></p>
            <p><?php echo __( 'Deal buyer will be charged ', 'couponxl').'<strong><span class="charged"></span></strong>'.__(' for each purchase.', 'couponxl' ) ?></p>
        </div>
        <div class="alert alert-info not_shared_info">
            ...
            <p><?php _e( 'Sell discounted products and services trough your store.', 'couponxl' ) ?></p>
            <p><?php echo __( 'Deal buyer will be charged ', 'couponxl').'<strong><span class="charged"></span></strong>'.__(' for each purchase.', 'couponxl' ) ?></p>
        </div>    
